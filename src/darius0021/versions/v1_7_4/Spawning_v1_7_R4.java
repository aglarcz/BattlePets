...
public class Spawning_v1_7_R4 implements Spawning {
	...
	public LivingEntity SpawnCreature (PlayerInteractEvent event, BattleMobs plugin) {
        ...
        List goalB = (List)Util.getPrivateField("b", PathfinderGoalSelector.class, Util.getPrivateField("goalSelector", EntityInsentient.class, tt)); goalB.clear();
        List goalC = (List)Util.getPrivateField("c", PathfinderGoalSelector.class, Util.getPrivateField("goalSelector", EntityInsentient.class, tt)); goalC.clear();
        List targetB = (List)Util.getPrivateField("b", PathfinderGoalSelector.class, Util.getPrivateField("targetSelector", EntityInsentient.class, tt)); targetB.clear();
        List targetC = (List)Util.getPrivateField("c", PathfinderGoalSelector.class, Util.getPrivateField("targetSelector", EntityInsentient.class, tt)); targetC.clear();
