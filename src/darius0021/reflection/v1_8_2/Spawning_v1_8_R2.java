package darius0021.reflection.v1_8_2;
...
import darius0021.reflection.v1_8_2.ArmorStandPlus;
import darius0021.reflection.v1_8_2.EntityTypes;
import darius0021.reflection.v1_8_2.WitherPet;
...
public class Spawning_v1_8_R2 implements Spawning {
	...
	public LivingEntity SpawnCreature (PlayerInteractEvent event, BattleMobs plugin) {
        ...
        List goalB = (List)Util.getPrivateField("b", PathfinderGoalSelector.class, tt.goalSelector); goalB.clear();
        List goalC = (List)Util.getPrivateField("c", PathfinderGoalSelector.class, tt.goalSelector); goalC.clear();
        List targetB = (List)Util.getPrivateField("b", PathfinderGoalSelector.class, tt.targetSelector); targetB.clear();
        List targetC = (List)Util.getPrivateField("c", PathfinderGoalSelector.class, tt.targetSelector); targetC.clear();
