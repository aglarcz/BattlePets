package darius0021.reflection.v1_9_1;
...
import darius0021.reflection.v1_9_1.ArmorStandPlus;
import darius0021.reflection.v1_9_1.EntityTypes;
...
public class Spawning_v1_9_R1 implements Spawning {
	...
	public LivingEntity SpawnCreature (PlayerInteractEvent event, BattleMobs plugin) {
		...
		Set goalB = (Set)Util.getPrivateField("b", PathfinderGoalSelector.class, tt.goalSelector); goalB.clear();
		Set goalC = (Set)Util.getPrivateField("c", PathfinderGoalSelector.class, tt.goalSelector); goalC.clear();
		Set targetB = (Set)Util.getPrivateField("b", PathfinderGoalSelector.class, tt.targetSelector); targetB.clear();
		Set targetC = (Set)Util.getPrivateField("c", PathfinderGoalSelector.class, tt.targetSelector); targetC.clear();
